            ...
            <div class="bg-gray-100 mx-5 lg:col-start-2 xl:col-start-2 xl:col-span-3 lg:col-span-5  bg-gray-100 hidden lg:block">
                <div class="grid lg:grid-cols-3 text-gray-700">
                    ...
                    <div class="col-span-1 px-5 py-5 text-justify">
                        ...
                        Ofrecer plantas y suculentas de alta calidad y brindar un servicio personalizado a cada uno de nuestros clientes. Nos esforzamos por satisfacer las necesidades de nuestros clientes y promover el cuidado y el bienestar de las plantas en nuestra comunidad.                        <br>
                        <p class="text-lg font-semibold">Visión</p>
                        Convertirnos en líderes en el rubro de venta de plantas y suculentas en Chillán y expandir nuestra presencia a nivel nacional. Queremos ser reconocidos por nuestro compromiso con la calidad y el servicio al cliente y contribuir al cuidado del medio ambiente a través de nuestros productos y prácticas empresariales sostenibles.                    </div>
                    <div class="col-span-1 px-5 py-5">
                        <p class="text-lg font-semibold">Ubicación:</p>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2264.12877058962!2d-72.07735557607229!3d-36.627310597800324!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x966929b8c145ebcd%3A0xed0b414116a5e489!2sPje.%20Niquen%202795%2C%203790999%20Niquen%2C%20Chillan%2C%20%C3%91uble!5e0!3m2!1sen!2scl!4v1671218762740!5m2!1sen!2scl" class="w-full h-full py-5" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div> 
                </div>
            </div>
            <div class="lg:hidden">
