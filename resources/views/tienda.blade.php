...
@section('content')
    <div class="lg:hidden">
        ...
        <div class="hidden md:block my-10 text-center flex-justify-center"
            style="background-image: url('{{ asset('img/banner/close-up-macro-of-green-leaf-1641721.jpg') }}')">
                    ...
                    @if (count($productos) > 0)
                        ...
                        @foreach ($productos as $producto)
                            <div class="col-span-1">
                                <x-card-producto :contador="$i" :categoria="$categoria" :minimo="$minimo" :maximo="$maximo"
                                    :producto="$producto" />
                            </div>
                            @php
                                $i++;
        ...
        <div class="grid xl:grid-cols-5 lg:grid-cols-7 w-full mt-5">
            ...
            <div class="lg:col-span-4 xl:col-span-2 lg:px-3">
                <div class="grid xl:grid-cols-3 p-5 lg:grid-cols-3 gap-4 lg:px-5">
                    @if (count($productos) > 0)
                        @foreach ($productos as $producto)
                            <x-card-producto :categoria="$categoria" :minimo="$minimo" :maximo="$maximo" :contador="0"
                                :producto="$producto" />
                        @endforeach
                    @else
