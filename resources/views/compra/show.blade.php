                    ...
                    <form action="{{ route('webpayPagar') }}" method="POST">
                        ...
                        <div class="lg:grid grid-cols-3">
                                    ...
                                    <div class="">
                                        <div id="direcciones" class="cols-span-2">
                                            <div id="direccion_antigua" class="space-y-2 break-all">
                                                <div class="flex">
                                                    ...
                                                    <div class="space-x-1 flex break-all">
                                                        <p> {{ $user->name }}</p>
                                                        <p>
                                            ...
                                            <div id="direccion_nueva" class="hidden space-y-4">
                                                ...
                                                <div>
                                                    <label class="relative">
                                                        <select name="region" id="regiones_envio"
                                                            class="border-2 rounded-md border-black border-opacity-20 outline-none focus:border-lime-500 w-full py-2.5 px-5 transition duration-200">
                                                ...
                                                <div>
                                                    <label class="relative">
                                                        <select name="comuna" id="comunas_envio"
                                                            class="border-2 rounded-md border-black border-opacity-20 outline-none focus:border-lime-500 w-full py-2.5 px-5 transition duration-200">
                                                ...
                                                <div>
                                                    <label class="relative">
                                                        <input name="correo" value="{{ old('correo') }}" type="text"
                                                            class="border-2 rounded-md border-black border-opacity-20 outline-none focus:border-lime-500 w-full py-1.5 px-5 transition duration-200"
                                                            placeholder=" ">
                                                        <span
                                                            class="text-opacity-30 text-black absolute text-xs md:text-sm left-0 top-0 mx-3 px-2 transition duration-200 input-text">
                                            ...
                                            <div class="my-10">
                                                <input hidden id="nueva" name="direccion_radio" value="1"
                                                    type="radio">
                                                <input hidden checked id="vieja" name="direccion_radio" value="2"
                                                    type="radio">
                                        ...
                                        <div class="col-span-2">
                                            ...
                                            <div class="grid w-full md:grid-cols-2 gap-5 h-full">
                                                <div>
                                                    <input checked type="radio" id="retiro_tienda" name="envio"
                                                        value="1" class="hidden peer">
                                                    <label for="retiro_tienda"
                                                        class="inline-flex items-center justify-between w-full p-5 text-gray-700 bg-gray-100 border border-gray-200 rounded-lg cursor-pointer peer-checked:border-lime-600 hover:text-lime-500 hover:border-lime-500 hover:bg-gray-100">
                                                        <div class="block">
                                                            <div class="w-full font-semibold">Retiro en tienda <i
                                                                    class="fa-solid fa-store"></i></div>
                                                            <div class="w-full text-xs">
                                                                <p>Retire su Compra en Pasaje Ñiquen 2795, Chillan.</p>
                                                                <p>Horario de Atención: Lunes a Viernes de 10:00 a 18:00
                                                                    hrs.</p>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="relative h-max">
                                                    ...
                                                    <input type="radio" id="domicilio" name="envio" value="2"
                                                    ...
                                                    <label for="domicilio"
                                                        ...
                                                        <div class="block">
                                                            <div class="w-full font-semibold">Envío por pagar <i
                                                                    class="fa-sharp fa-solid fa-truck-fast"></i></div>
                                                            <div class="w-full text-xs">El envio será manejado por Starken
                                                                a la dirección que nos proporciona, el valor del envio será
                                                                manejado por Starken</div>
                                                        </div>
                            ...
                            <div class="col-span-1 border-2 px-5 pt-5 mx-5 lg:mx-0 relative h-min">
                                ...
                                @for ($i = 0; $i < count($carrito); $i++)
                                    <div class="columns-2 text-green-500 py-2 border-b">
                                        <div class="flex items-center space-x-2">
                                            <div class="md:hidden">
                                                @if (strlen($carrito[$i]['nombre_producto']) > 20)
                                ...
                                <div class="space-y-3">
                                    <div class="flex justify-center">
                                        <img class="w-52" src="{{ asset('img/logos/1.WebpayPlus_FB_800px.png') }}"
                                            alt="">
                                    </div>
        ...
        $(document).ready(function() {
            ...
            $('#domicilio').click(function() {
                if ($(this).is(':checked')) {
                    ...
                    if (!$('#boton_viejo').hasClass('hidden')) {} else {
                        $('#boton_nuevo').removeClass('hidden');
                    }
        ...
        $(document).ready(function() {
            ...
            $('#regiones_envio').change(function() {
                ...
                for (let i = 0; i < comunas_filtradas.length; i++) {
                    $('#comunas_envio').append('<option value="' + comunas_filtradas[i].id + '">' +
                        comunas_filtradas[i].nombre_comuna + '</option>');
                }
