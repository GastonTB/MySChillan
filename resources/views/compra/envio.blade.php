...
@section('content')
    ...
    <div class="container w-full md:w-4/5 xl-3/5 mx-auto px-2 mt-10">
        <div class="">
            ...
            <a class="text-lime-500" href="{{ route('verCompras') }}">Lista de Compras con Envío a Docimicilio</a>
        </div>
        <div class="flex justify-center">
            <p class="text-3xl font-bold my-3">
                Lista de Compras con Envío a Docimicilio
            </p>
        </div>

        <div class="grid grid-cols-1 lg:grid-cols-2 mb-3">
            <div class="order-2 lg:order-1 mt-5 lg:mt-0">
                <form method="POST" id="formulario_ordenar" action="{{ route('filtrarComprasEnvio') }}">
                    @csrf
            ...
            <div class="flex lg:justify-end order-1 lg:order-2">
                <form action="{{ route('buscarComprasEnvio') }}" method="POST">
