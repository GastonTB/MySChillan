            ...
            <div class="md:col-span-2 xl:col-span-2 xl:col-start-4">
                <div class="md:mt-0 mt-10 mb-5 flex justify-start pl-5">
                    <p>
                        ...
                        <a class="text-lime-500"
                            href="{{ route('filtrados', ['id' => $producto->categoria_id, 'minimo' => 0, 'maximo' => 100000, 'orden' => 1, 'nombre' => '999']) }}">{{ $producto->categoria->nombre_categoria }}</a>
                        /
                ...
                <div class="justify-start pl-5 flex mb-3">
                    <ul>
                        ...
                        @if ($producto->calificaciones->isNotEmpty())
                            <div class="flex items-center mb-3">
                                <p class="font-semibold mr-2">Calificación:</p> <p class="">{{ number_format($producto->calificaciones->avg('puntuacion'), $producto->calificaciones->avg('puntuacion') == floor($producto->calificaciones->avg('puntuacion')) ? 0 : 1, ',', '.') }}/5</p>
                            ...
                            <div>
                                <p class="font-semibold cursor-pointer titulo mb-2" id="titulo-{{ $i }}">
                                    @switch($i)
                                        ...
                                        @case(2)
                                            Cuidados: <i id="fl-ar-2" class="fa fa-chevron-up"></i><i id="fl-ab-2"
                                                class="fa fa-chevron-down hidden"></i>
                                        @break

                                        @case(3)
                                            Temporada: <i id="fl-ar-3" class="fa fa-chevron-up"></i><i id="fl-ab-3"
                                                class="fa fa-chevron-down hidden"></i>
                                        @break
                    ...
                    <div class="my-10">
                        ...
                        @else
                            ...
                            @guest
                                ...
                                @endphp
                            @endguest
                            <form id="formulario_agregar" action="{{ route('actualizarCarrito', $id_carrito) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="flex space-x-2">
                                    <div id="menos"
                                        class="flex boton items-center justify-end text-lime-500 font-black cursor-pointer">
                                        <i class="fa fa-minus"></i>
                                    </div>
                                    <div class="border-2 col-span-3 xl:col-span-2">
                                        <input value="1" id="cantidad" min="1" max="20" placeholder="1"
                                            type="number" name="cantidad" class="border-2 text-gray-500 text-center"
                                            style="width: 100%; height:100%">
                                    </div>
                                    <div id="mas"
                                        class="flex boton items-center text-lime-500 font-black cursor-pointer">
