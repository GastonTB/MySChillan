            ...
            <div class="md:col-span-2 md:col-start-1 lg:col-start-2 xl:col-start-2 lg:col-span-3 xl:col-span-2 md:pl-5 lg:pl-0 mb-10 md:mb-0 order-1 md:order-1">
                ...
                <div class="mt-5 px-5">
                    <div class="flex space-x-5">
                        <div>
                            <label class="relative">
                                <input name="precio" value="{{old('precio', '$'.number_format($producto->precio, 0, ",", "."))}}" type="text" class="border-2 rounded-md border-black border-opacity-20 outline-none focus:border-lime-500 w-full py-1.5 px-5 transition duration-200" placeholder=" " id="precio">
                                <span class="text-opacity-30 text-black absolute left-0 top-0 mx-3 px-2 transition duration-200 input-text">
                                    Precio
                                </span>
                            </label>
                        ...
                        <div>
                            <label class="relative">
                                <input name="cantidad" value="{{old('cantidad', $producto->cantidad)}}" type="text" class="border-2 rounded-md border-black border-opacity-20 outline-none focus:border-lime-500 w-full py-1.5 px-5 transition duration-200" placeholder=" " id="cantidad">
                                <span class="text-opacity-30 text-black absolute left-0 top-0 mx-3 px-2 transition duration-200 input-text">
                                    Cantidad
                                </span>
                            </label>
                ...
                <div class="mb-5 mt-10 px-5">
                    <div class="mt-5">
                        ...
                        <div class="pl-5">
                            ...
                            <div>
                                <input id="{{$categoria->id}}" name="categorias[]" 
                                value="{{$categoria->id}}"
                                @if(is_array(old('categorias')) && in_array($categoria->id, old('categorias')))         
                                    checked 
                                @elseif($producto->categoria_id == $categoria->id)
                                    checked
                                @endif
                ...
                <div class="flex justify-center">
                    <div class="mt-0 md:mt-5">
                        ...
                        <div class="text mb-10">
                            <textarea id="descripcion-text" class="border-2 texto" name="descripcion_text" id="" cols="49" rows="7">{{old('descripcion_text', $producto->descripcion[0])}}</textarea>
                            <div id="temporada-text" class="texto hidden">
                                ...
                                <div class="mt-5">
                                    ...
                                    @for($i=0; $i<count($temporadas) ;$i++)
                                        ...
                                        @endif
                                    @endfor
                                    @if(is_array(old('temporada_text')) && in_array(1, old('temporada_text'))) checked @endif class="rounded-md hover:bg-lime-500 hover:animate-ping ease-in-out delay-150 form-check-input appearance-none h-4 w-4 border border-gray-300 bg-white checked:bg-green-500 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="checkbox">
                                ...
                                <div>
                                    ...
                                    @for($i=0; $i<count($temporadas) ;$i++)
                                        ...
                                        @endif
                                    @endfor
                                    @if(is_array(old('temporada_text')) && in_array(2, old('temporada_text'))) checked @endif class="rounded-md hover:bg-lime-500 hover:animate-ping ease-in-out delay-150 form-check-input appearance-none h-4 w-4 border border-gray-300 bg-white checked:bg-green-500 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="checkbox">
                                ...
                                <div>
                                    ...
                                    @for($i=0; $i<count($temporadas) ;$i++)
                                        ...
                                        @endif
                                    @endfor
                                    @if(is_array(old('temporada_text')) && in_array(3, old('temporada_text'))) checked @endif class="rounded-md hover:bg-lime-500 hover:animate-ping ease-in-out delay-150 form-check-input appearance-none h-4 w-4 border border-gray-300 bg-white checked:bg-green-500 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="checkbox">
                                ...
                                <div>
                                    ...
                                    @for($i=0; $i<count($temporadas) ;$i++)
                                        ...
                                        @endif
                                    @endfor
                                    @if(is_array(old('temporada_text')) && in_array(4, old('temporada_text'))) checked @endif class="rounded-md hover:bg-lime-500 hover:animate-ping ease-in-out delay-150 form-check-input appearance-none h-4 w-4 border border-gray-300 bg-white checked:bg-green-500 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="checkbox">
