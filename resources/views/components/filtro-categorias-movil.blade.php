            ...
            <div id="filtros" class="pb-5 hidden  md:block">
                    ...
                    <li class="py-2 hover:text-lime-500">
                        <div class="form-check">
                            <input name="categoria[]" value="1"
                                @if (!empty($categoria)) @if ($categoria == 1)
                                checked @endif
                                @endif
                    ...
                    <li class="py-2 hover:text-lime-500">
                        <div class="form-check">
                            <input name="categoria[]" value="2"
                                @if (!empty($categoria)) @if ($categoria == 2)
                                    checked @endif
                                @endif
                            class="categoria rounded-md hover:bg-lime-500 hover:animate-ping ease-in-out delay-150 form-check-input appearance-none h-4 w-4 border border-gray-300 bg-white checked:bg-green-500 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                            type="checkbox" >
                    ...
                    <li class="py-2 hover:text-lime-500">
                        <div class="form-check">
                            <input name="categoria[]" value="3"
                                @if (!empty($categoria)) @if ($categoria == 3)
                                    checked @endif
                                @endif
                            class="categoria rounded-md hover:bg-lime-500 hover:animate-ping ease-in-out delay-150 form-check-input appearance-none h-4 w-4 border border-gray-300 bg-white checked:bg-green-500 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                            type="checkbox" >
                    ...
                    <li class="py-2 hover:text-lime-500">
                        <div class="form-check">
                            <input name="categoria[]" value="4"
                                @if (!empty($categoria)) @if ($categoria == 4)
                                    checked @endif
                                @endif
                            class="categoria rounded-md hover:bg-lime-500 hover:animate-ping ease-in-out delay-150 form-check-input appearance-none h-4 w-4 border border-gray-300 bg-white checked:bg-green-500 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                            type="checkbox" >
                    ...
                    <li class="py-2 hover:text-lime-500">
                        <div class="form-check">
                            <input name="categoria[]" value="5"
                                @if (!empty($categoria)) @if ($categoria == 5)
                                    checked @endif
                                @endif
                            class="categoria rounded-md hover:bg-lime-500 hover:animate-ping ease-in-out delay-150 form-check-input appearance-none h-4 w-4 border border-gray-300 bg-white checked:bg-green-500 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                            type="checkbox">
                    ...
                    <li class="py-2 hover:text-lime-500">
                        <div class="form-check">
                            <input name="categoria[]" value="6"
                                @if (!empty($categoria)) @if ($categoria == 6)
                                    checked @endif
                                @endif
                    ...
                    <li class="py-2 hover:text-lime-500">
                        <div class="form-check">
                            <input name="categoria[]" value="7"
                                @if (!empty($categoria)) @if ($categoria == 7)
                                    checked @endif
                                @endif
                            class="categoria rounded-md hover:bg-lime-500 hover:animate-ping ease-in-out delay-150 form-check-input appearance-none h-4 w-4 border border-gray-300 bg-white checked:bg-green-500 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                            type="checkbox" >
                    ...
                    <li class="py-2 hover:text-lime-500">
                        <div class="form-check">
                            <input name="categoria[]" value="8"
                                @if (!empty($categoria)) @if ($categoria == 8)
                                    checked @endif
                                @endif
                            class="categoria rounded-md hover:bg-lime-500 hover:animate-ping ease-in-out delay-150 form-check-input appearance-none h-4 w-4 border border-gray-300 bg-white checked:bg-green-500 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                            type="checkbox" >
                    ...
                    <li class="py-2 hover:text-lime-500">
                        <div class="form-check">
                            <input name="categoria[]" value="9"
                                @if (!empty($categoria)) @if ($categoria == 9)
                                    checked @endif
                                @endif
                            class="categoria rounded-md hover:bg-lime-500 hover:animate-ping ease-in-out delay-150 form-check-input appearance-none h-4 w-4 border border-gray-300 bg-white checked:bg-green-500 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                            type="checkbox" >
                ...
                <div class="lg:hidden border-lg pb-5 px-5">
                    ...
                    <div class="p-5 bg-white rounded-md mb-3">
                        <input name="minimo" type="range" min="0" max="100000" value="{{ $minimo }}"
                            step="10000"
                    ...
                    <div class="p-5 bg-white rounded-md">
                        <input name="maximo" type="range" min="0" max="100000" value="{{ $maximo }}"
                            step="10000"
