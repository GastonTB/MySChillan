...
<div>
    <div id="modal-registro" class="hidden">
        ...
        {{-- <div class="flex justify-center">
            <div class="top-1/12 z-50 w-11/12 bg-white fixed overflow-y-auto">
                <form action="{{route('registro')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid h-full grid-cols-2 grid-rows-16 gap-3"> 
                            ...
                            <div class="mx-3">
                                <div>
                                    <div>
                                        ...
                                        <input id="nombre" name="p-nombre" type="text" class=" border text-black text-sm rounded-sm block w-full p-2.5 border-gray-200 placeholder-gray-400" placeholder="Primer Nombre" >
                            ...
                            <div class="mx-3">
                                <div>
                                    <div>
                                        ...
                                        <input name="direccion" type="text" class=" border text-black text-sm rounded-sm block w-full p-2.5 border-gray-200 placeholder-gray-400" placeholder="Calle, Numero de Casa, Depto" >
                            ...
                            <div class="mx-3">
                                <div>
                                    <div>
                                        ...
                                        <input name ="apellido_paterno" type="text" class=" border text-black text-sm rounded-sm  block w-full p-2.5 border-gray-200 placeholder-gray-400" placeholder="Apellido Paterno" >
                            ...
                            <div class="mx-3">
                                <div>
                                    <div>
                                        ...
                                        <input name="apellido_materno" name="" type="text" class=" border text-black text-sm rounded-sm  block w-full p-2.5 border-gray-200 placeholder-gray-400" placeholder="Apellido Materno" >
                            ...
                            <div class="mx-3">
                                <div>
                                    <div>
                                        ...
                                        <select id="comunas" class="border border-gray-200 text-gray-900 text-sm rounded-am  block w-full p-2.5">
                            ...
                            <div class="mx-3">
                                <div>
                                    <div>
                                        ...
                                        <input type="text" class=" border text-black text-sm rounded-sm  block w-full p-2.5 border-gray-200 placeholder-gray-400" placeholder="correo@correo.cl" >
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="mx-3">
                                <div>
                                    <div>
                                        ...
                                        <input type="password" class=" border text-black text-sm rounded-sm  block w-full p-2.5 border-gray-200 placeholder-gray-400" placeholder="********" >
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="mx-3">
                                <div>
                                    <div>
                                        ...
                                        <input type="text" class=" border text-black text-sm rounded-sm  block w-full p-2.5 border-gray-200 placeholder-gray-400" placeholder="+569 99 999 999" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mx-auto col-span-2 py-5">
                            <button type="submit" class="text-lg font-bold px-6 py-2.5 bg-green-500 text-white rounded hover:bg-white hover:text-green-500 hover:shadow-lg ">Ingresar</button type="submit">
                        </div>
                    </div>
                </form>     
            </div>
        ...
        <div class="flex justify-center">
            <div class="top-17/400 md:top-1/6 lg:top-17/400 md:text-lg z-50 w-11/12 h-11/12 md:h-6/12 lg:h-3/4 lg:w-1/2 bg-white fixed outline-none overflow-x-hidden overflow-y-auto">
                <div class="lg:px-5">
                    <form action="{{route('registro')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="grid h-full grid-cols-2 grid-rows-16 gap-3"> 
