                ...
                <div class="container grid place-items-center">
                    <div class="imagen relative flex-shrink-0">
                        ...
                        <div class="grid place-items-center">
                            ...
                            <a href="{{route('filtrados', ['id' => 1, 'minimo' => 0, 'maximo' => 100000, 'orden' => 1, 'nombre' => '999'])}}">Ornamentales</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="imagen relative flex-shrink-0">
                        ...
                        <div class="grid place-items-center">
                            <div class="absolute bottom-1/6 btn-primary">
                                <a href="{{route('filtrados', ['id' => 2, 'minimo' => 0, 'maximo' => 100000, 'orden' => 1, 'nombre' => '999'])}}">Interior</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="swiper-slide flex justify-center">
                <div class="container grid place-items-center">
                    <div class="imagen relative flex-shrink-0">
                        ...
                        <div class="grid place-items-center">
                            <div class="absolute bottom-1/6 btn-primary">
                                <a href="{{route('filtrados', ['id' => 3, 'minimo' => 0, 'maximo' => 100000, 'orden' => 1, 'nombre' => '999'])}}">Exterior</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="swiper-slide flex justify-center">
                <div class="container grid place-items-center">
                    <div class="imagen relative flex-shrink-0">
                        ...
                        <div class="grid place-items-center">
                            <div class="absolute bottom-1/6 btn-primary">
                                <a href="{{route('filtrados', ['id' => 4, 'minimo' => 0, 'maximo' => 100000, 'orden' => 1, 'nombre' => '999'])}}">Suculentas</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="imagen relative flex-shrink-0">
                        ...
                        <div class="grid place-items-center">
                            <div class="absolute bottom-1/6 text-xs py-3.5 btn-primary">
                                <a href="{{route('filtrados', ['id' => 5, 'minimo' => 0, 'maximo' => 100000, 'orden' => 1, 'nombre' => '999'])}}">Árboles Frutales</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="swiper-slide flex justify-center">
                <div class="container grid place-items-center">
                    <div class="imagen relative flex-shrink-0">
                        ...
                        <div class="grid place-items-center">
                            <div class="absolute bottom-1/6 btn-primary">
                                <a href="{{route('filtrados', ['id' => 6, 'minimo' => 0, 'maximo' => 100000, 'orden' => 1, 'nombre' => '999'])}}">Maceteros</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="imagen relative flex-shrink-0">
                        ...
                        <div class="grid place-items-center">
                            <div class="absolute bottom-1/6 btn-primary text-xs py-3.5">
                                <a href="{{route('filtrados', ['id' => 7, 'minimo' => 0, 'maximo' => 100000, 'orden' => 1, 'nombre' => '999'])}}">Tierra de Hoja</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="swiper-slide flex justify-center">
                <div class="container grid place-items-center">
                    <div class="imagen relative flex-shrink-0">
                        ...
                        <div class="grid place-items-center">
                            <div class="absolute bottom-1/6 btn-primary">
                                <a href="{{route('filtrados', ['id' => 8, 'minimo' => 0, 'maximo' => 100000, 'orden' => 1, 'nombre' => '999'])}}">Accesorios</a>
                            </div>
                        </div>
                    </div>
                </div>
