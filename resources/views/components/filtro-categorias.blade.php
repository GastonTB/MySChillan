        ...
        <div class="pb-5">
            ...
            <div class="hidden lg:block border-lg pb-5 px-5">
                ...
                <div class="p-5 bg-white mb-3">
                    <input name="minimo" type="range" min="0" max="100000" value="{{$minimo}}" step="10000" class="minimo2 w-full h-2 rounded-lg appearance-none cursor-pointer bg-gray-700">
                </div>
                <span class="text-sm ml-5 mt-10" style="color:red"><small>@error('minimo'){{$message}}@enderror</small></span>                                                           
                <label class="mb-2 font-black text-gray-700 flex">Precio Máximo: <p class="precio_maximo2 text-lime-500 ml-1"></p></label>
                <div class="p-5 bg-white">
                    <input name="maximo" type="range" min="0" max="100000" value="{{$maximo}}" step="10000" class="maximo2 w-full h-2 rounded-lg appearance-none cursor-pointer bg-gray-700">
                </div>
