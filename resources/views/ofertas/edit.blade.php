            ...
            <div class="flex justify-center">
                <div class="md:w-7/10 xl:w-1/4 lg:w-1/3 w-9/10 mt-10">
                    <div class="flex justify-center mb-2 text-lg font-bold crear">
                        Modificar Oferta para Producto: {{ $producto->nombre_producto }}
                    </div>
                    <div class="px-3 flex justify-center md:text-lg lg:text-xl font-bold mb-5" id="nombre-modal">

                    </div>
                    <form id="form-oferta" action="{{ route('editarOferta') }}" method="POST">
                        @csrf
                        <div id="method"></div>
                        ...
                        <div class="grid grid-cols-2 mb-5">
                                        ...
                                        <div>
                                            <label class="relative">
                                                <input disabled id="precio-antiguo" name="precio_antiguo" type="text"
                                                    class=" border-2 rounded-md border-red-500 border-opacity-20 outline-none focus:border-lime-500 w-full py-1.5 px-5 transition duration-200"
                                                    placeholder=" "
                                        ...
                                        <div class="mt-5">
                                            <label class="relative">
                                                <input disabled id="precio-antiguo" name="precio_antiguo" type="text"
                                                    class=" border-2 rounded-md border-red-500 border-opacity-20 outline-none focus:border-lime-500 w-full py-1.5 px-5 transition duration-200"
                                                    placeholder=" "
                                                    value="${{ number_format($producto->oferta->precio_oferta, 0, ',', '.') }}">
                                                <span
                                                    class="text-opacity-30 text-gray-700 absolute text-xs md:text-sm left-0 top-0 mx-3 px-2 transition duration-200 input-text borde">
                                                    Precio Oferta
                                                </span>
                            ...
                            <div class="col-span-1">
                                <div class="medio flex items-center justify-center h-full">
                                    <div class="flex-grow">
                                        <div class="md:px-10 px-3">
                                            <label class="relative">
                                                <input required id="precio-oferta" name="oferta"
                                                    value="{{ old('oferta') ? old('oferta') : '$' . number_format($producto->oferta->precio_oferta, 0, ',', '.') }}"
                                                    type="text"
                                ...
                                <div class="md:px-10 px-3">
                                    <label class="relative">
                                        <input autocomplete="off" required id="fecha_ini" name="fecha_ini"
                                            value="{{ old('fecha_ini') ? old('fecha_ini') : $producto->oferta->fecha_inicio }}"
                                            type="text"
                                ...
                                <div class="md:px-10 px-3">
                                    <label class="relative">
                                        <input autocomplete="off" required id="fecha_ter" name="fecha_ter"
                                            value="{{ old('fecha_ter') ? old('fecha_ter') : $producto->oferta->fecha_fin }}"
                                            type="text"
                                            class="datepicker border-2 rounded-md border-black border-opacity-20 outline-none focus:border-lime-500 w-full py-1.5 px-5 transition duration-200"
                                            placeholder=" ">
                                        <span
                        ...
                        <div class="flex justify-center m-10 space-x-5">
