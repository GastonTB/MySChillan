<div class="border-1 rounded-md bg-gray-100 shadow-md mb-10 md:mb-0 xl:relative xl:w-4/5">
    ...
    <form action="<?php echo e(route('filtrar')); ?>" method="POST">
        ...
        <div class="pb-5">
            ...
            <span class="text-sm ml-5 mt-10" style="color:red"><small><?php $__errorArgs = ['categorias'];
...
unset($__errorArgs, $__bag); ?></small></span>                                                           
            <div class="hidden lg:block border-lg pb-5 px-5">
                ...
                <div class="p-5 bg-white mb-3">
                    <input name="minimo" type="range" min="0" max="100000" value="<?php echo e($minimo); ?>" step="10000" class="minimo2 w-full h-2 rounded-lg appearance-none cursor-pointer bg-gray-700">
                </div>
                <span class="text-sm ml-5 mt-10" style="color:red"><small><?php $__errorArgs = ['minimo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><?php echo e($message); ?><?php unset($message);
...
unset($__errorArgs, $__bag); ?></small></span>                                                           
                ...
                <div class="p-5 bg-white">
                    <input name="maximo" type="range" min="0" max="100000" value="<?php echo e($maximo); ?>" step="10000" class="maximo2 w-full h-2 rounded-lg appearance-none cursor-pointer bg-gray-700">
                </div>
                <span class="text-sm ml-5 mt-10" style="color:red"><small><?php $__errorArgs = ['maximo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><?php echo e($message); ?><?php unset($message);
