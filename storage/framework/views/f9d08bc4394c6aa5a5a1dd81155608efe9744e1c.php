        ...
        <div class="columns-2 mb-5">
            <div class="flex justify-start">
                <div class="items-center">
                    <a id="logo" href="<?php echo e(route('inicio')); ?>" class="">
                        <img class="object-scale-down h-16 md:h-20" src="<?php echo e(asset('img/logos/logo.png')); ?>" alt="">
                    </a>
                    ...
                    <div class="flex">
                        <div class="mr-4">
                            <div class="flex hover:text-lime-500">
                                ...
                                <?php if(auth()->guard()->check()): ?>
                                    ...
                                    <p>
                                        <a id="usuario" href="<?php echo e(route('perfil', Auth::user()->id)); ?>"><?php echo e(Auth::user()->name); ?></a>
                                    </p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="flex hover:text-lime-500">
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                ...
                                <p>
                                    <a id="logout" href="<?php echo e(route('salir')); ?>">Cerrar Sesión</a>
                                </p>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-4 items-center">
                <div class="flex justify-end">
                    <a href="<?php echo e(route('inicio')); ?>">
                        <img class="object-scale-down h-14" src="<?php echo e(asset('img/logos/logo.png')); ?>" alt="">
                    </a>
                </div>
                <div class="grid col-span-2 justify-evenly font-black text-lime-500">
                    <div class="flex <?php if(auth()->guard()->check()): ?>
                    lg:space-x-8 xl:space-x-10
                    <?php endif; ?> space-x-16">
                        <div>
                            <a href="<?php echo e(route('inicio')); ?>">
                        ...
                        <div>
                            <a href="<?php echo e(route('tienda')); ?>">
                                <p class=" hover:text-black">
                                    TIENDA
                                </p>
                            </a>
                        ...
                        <div class="relative">
                            <div id="admin">
                                <a href="<?php echo e(route('backoffice')); ?>">
                                    <p class=" hover:text-black">
                                        BACK OFFICE
                                    </p>
                                </a>
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <div>
                                <p class=" hover:text-black">
                                    <a href="<?php echo e(route('perfil', Auth::user()->id)); ?>">PERFIL</a>
                                </p>
                            </div>
                        <?php endif; ?>
                        <div>
                            <p class=" hover:text-black">
                                <a href="<?php echo e(route('nosotros')); ?>">SOBRE NOSOTROS</a>
                            </p>
                        </div>
                    </div>
                </div>
...
</div><?php /**PATH C:\xampp\htdocs\MySPlantas\resources\views/components/navbar.blade.php ENDPATH**/ ?>