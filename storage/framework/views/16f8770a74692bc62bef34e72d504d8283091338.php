    ...
    <div id="modal-cantidad" class="hidden">
        ...
        <div class="flex justify-center">
            <div class="top-1/5 rounded-md w-9/10 md:w-4/10 lg:w-3/10 xl:w-2/10  z-50 bg-white fixed outline-none">
                ...
                <form id="form-stock" method="POST" action="<?php echo e(route('aumentarStock')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex justify-center">
                        <span class="text-sm errores mb-5" style="color:red"><small>
                                <?php $__errorArgs = ['cantidad_stock'];
...
<?php $__env->startSection('content'); ?>
    <div class="container w-full md:w-4/5 xl-3/5 mx-auto px-2 mt-10">
        <div class="">
            ...
            <a class="text-lime-500" href="<?php echo e(route('listado-productos')); ?>">Listado de Productos</a>
        </div>
        <div class="flex justify-center">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 mb-3">
            <div class="order-2 lg:order-1 mt-5 lg:mt-0">
                <form method="POST" id="formulario_ordenar" action="<?php echo e(route('filtrarProductosAdmin')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="flex space-x-1">
                        <select name="categoria" id="select_categoria"
                            ...
                            <?php if(isset($categoria)): ?>
                                <option <?php if($categoria == 1): ?> selected <?php endif; ?> value="1">
                                    Nombre
                                </option>
                                <option <?php if($categoria == 2): ?> selected <?php endif; ?> value="2">
                                    Precio
                                </option>
                                <option <?php if($categoria == 3): ?> selected <?php endif; ?> value="3">
                                    Cantidad
                                </option>
                                <option <?php if($categoria == 4): ?> selected <?php endif; ?> value="4">
                                    Categoria
                                </option>
                                <option <?php if($categoria == 5): ?> selected <?php endif; ?> value="5">
                                    Calificación
                                </option>
                            <?php else: ?>
                                <option value="1">
                        ...
                        <select id="select_orden"
                            class="border-2 rounded-md px-5 border-black border-opacity-20 outline-none focus:border-lime-500 py-2 transition duration-200"
                            name="orden">
                            <?php if(isset($ordenar)): ?>
                                <option class="desc" <?php if($ordenar == 1): ?> selected <?php endif; ?> value="1">
                                    Descendiente
                                </option>
                                <option class="asc" <?php if($ordenar == 2): ?> selected <?php endif; ?> value="2">
                                    Ascendente
                                </option>
                            <?php else: ?>
                        ...
                        <?php if($search != 'todo'): ?>
                            <div class="mt-1 flex items-center">
                                <p class="text-gray-500 p-1 border-2 rounded-md border-opacity-60 border-lime-500">
                                    Resultados para la busqueda: <?php echo e($search); ?> <a
                                        href="<?php echo e(route('listado-productos')); ?>"
                    ...
                    <input type="hidden" name="busqueda"
                        <?php if(isset($search)): ?> value="<?php echo e($search); ?>" <?php endif; ?>>
                </form>
            </div>
            <div class="flex lg:justify-end order-1 lg:order-2">
                <form action="<?php echo e(route('buscarProductoAdmin')); ?>" method="POST">
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="bg-white border-b  hover:bg-gray-100">
                            <td id="nombre-producto-<?php echo e($producto->id); ?>" scope="row"
                                class="line py-4 px-6 font-medium text-gray-700 whitespace-nowrap ">
                                <div class="flex items-center">
                                    <a class="text-lime-500 font-semibold" href="<?php echo e(route('detalles', $producto->id)); ?>">
                            ...
                            <td id="precio-producto-<?php echo e($producto->id); ?>" class="py-4 px-6">
                                $<?php echo e($producto->precio); ?>

                            </td>
                            <td id="cantidad-producto-<?php echo e($producto->id); ?>" class="py-4 px-6">
                            ...
                            <td class="py-4 px-6 flex">
                                <?php if($producto->calificaciones_avg_puntuacion): ?>
                                    <?php
                                    ...
                                    ?>
                                    <p class="flex justify-start items-center"><?php echo e($promedio); ?> <i
                            ...
                            <td class="py-4 px-6">
                                <?php if($producto->oferta == null): ?>
                                    <div class="flex justify-center">
                                        <a href="<?php echo e(route('crear-oferta-mostrar', $producto->id)); ?>"
                                            id="<?php echo e($producto->id); ?>" class="boton-oferta btn-tienda">
                                            Agregar
                                            <i class="fa fa-tag"></i>
                                        </a>
                                ...
                                <?php else: ?>
                                    <div class="flex justify-center">
                                        <a href="<?php echo e(route('modificar-oferta-mostrar', $producto->id)); ?>"
                                            id="<?php echo e($producto->id); ?>" class="boton-oferta btn-tienda">
                                            Ver Oferta
                                            <i class="fa fa-tag"></i>
                                        </a>
                            ...
                            <td id="oferta-id-<?php echo e($producto->id); ?>" class="py-4 px-6 hidden">
                                <?php if($producto->oferta_id != 0): ?>
                                    <?php echo e($producto->oferta->id); ?>

                                <?php endif; ?>
                            <td class="py-4 px-6 hidden" id="oferta-hidden-<?php echo e($producto->id); ?>">
                                <?php if($producto->oferta_id != 0): ?>
                                    $<?php echo e($producto->oferta->precio_oferta); ?>

                                <?php endif; ?>
                            </td>
                            <td class="py-4 px-6 hidden" id="fecha-inicio-hidden-<?php echo e($producto->id); ?>">
                                <?php if($producto->oferta_id != 0): ?>
                                    <?php echo e($producto->oferta->fecha_inicio); ?>

                                <?php endif; ?>
                            </td>
                            <td class="py-4 px-6 hidden" id="fecha-termino-hidden-<?php echo e($producto->id); ?>">
                                <?php if($producto->oferta_id != 0): ?>
                                    <?php echo e($producto->oferta->fecha_fin); ?>

                                <?php endif; ?>
                            </td>
                            <td class="py-4 px-6">
                                <button id="boton-stock-<?php echo e($producto->id); ?>" class="btn-tienda bg-yellow-500 stock">
                            ...
                            <td class="py-4 px-6">
                                <div class="flex justify-center">
                                    <a href="<?php echo e(route('editarProducto', $producto->id)); ?>"
                            ...
                            <td class="py-4 px-6">
                                <?php if($producto->trashed()): ?>
                                    <div class="flex justify-center">
                                        <form id="recuperar-<?php echo e($producto->id); ?>"
                                            action="<?php echo e(route('recuperarProducto', $producto->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="button" id="<?php echo e($producto->id); ?>"
                                ...
                                <?php else: ?>
                                    <div class="flex justify-center">
                                        <form id="eliminar-<?php echo e($producto->id); ?>"
                                            action="<?php echo e(route('borrarProducto', $producto->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="button" id="<?php echo e($producto->id); ?>"
...
<?php echo $__env->make('layaouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MySPlantas\resources\views/productos/index.blade.php ENDPATH**/ ?>